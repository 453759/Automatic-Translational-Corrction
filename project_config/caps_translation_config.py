...
def get_args():
    ...
    parser.add_argument('--txt_path', type=str,
                        default="/home/star/Projects/g4/cy/AutomaticTranslateCorrection/caps/matched_pairs_R.txt",
    ...
    parser.add_argument('--output_txt_path', type=str,
                        default='/home/star/Projects/g4/cy/AutomaticTranslateCorrection/data_R/comparative_experiment/caps_translation.txt')
