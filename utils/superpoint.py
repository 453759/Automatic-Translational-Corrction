...
class PointTracker(object):
    ...
    def update(self, pts, desc):
        ...
        # Save current frame's tracks to all_tracks
        self.all_tracks.append(self.tracks.copy())
...
class VideoStreamer(object):
    ...
    def read_image(self, impath, img_size):
        ...
        if grayim is None:
            print(f"Error: Unable to load image at path {impath}")
    ...
    def next_frame(self):
        ...
        Returns
           ...
           image_name: The name of the image (if available).
        """
