...
def translation(args, records):
    ...
    for i in range(1, 6):
        ...
        translation.append(optimization.differential_evolution(optimization.fitness_function, args.num_generations, line_and_point_data[:, :3],
    ...
    for i in range(0, 5):
        ...
        forward_offset = translation[i]  # 累加 translation_total
