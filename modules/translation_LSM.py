...
def translation(args, records):
    ...
    for i, (im_pth, position) in enumerate(zip(im_pths, positions)):
        ...
        translation_forward.append(LSM.find_translation_vector_with_reg(line_and_point_data[:, 3:], line_and_point_data[:, :3]))
    ...
    for i, (im_pth, position) in enumerate(zip(im_pths, positions)):
        ...
        translation_backward.append(LSM.find_translation_vector_with_reg(line_and_point_data[:, 3:], line_and_point_data[:, 3]))
